...
[Имя Пилота] ([Название команды])

Вероятность победы: [X]%

Вероятность подиума: [Y]%

Обоснование: [Краткая причина, почему именно он. Например: Лидер чемпионата, показал лучшее время на длинных сериях в практиках, его машина идеально подходит для быстрых поворотов этой трассы].)
